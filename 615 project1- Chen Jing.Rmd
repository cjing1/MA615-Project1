...
require(ROCR) 
require(maps)
recs <- read.csv('～recs2015_public_v1.csv', na.strings = c("", "NA"))
refrig1<-read.csv('～recs2015_public_v1.csv')
```
...
```{r, fig.height=5, fig.width=8, warning=FALSE,echo=FALSE, message=FALSE}
recs %>% 
  group_by(MONEYPY) %>%
